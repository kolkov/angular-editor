...
import { AngularEditorToolbarConfig } from './toolbar-config';
...
export class AngularEditorComponent implements OnInit, ControlValueAccessor, AfterViewInit, OnDestroy {
    ...
    @Input() toolbarConfig: AngularEditorToolbarConfig;

    @Input() placeholder = '';
    @Input() tabIndex: number | null;
    @Input() givenContent: string;
    ...
    ngAfterViewInit() {
        ...
        if (this.givenContent) {
            this.textArea.nativeElement.innerHTML = this.givenContent;
        }
    }
