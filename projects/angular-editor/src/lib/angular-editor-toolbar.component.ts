...
import {
    ...
    angularEditorToolbarDefaultConfig,
} from './toolbar-config';
...
export class AngularEditorToolbarComponent implements OnChanges {
    ...
    finalConfig = angularEditorToolbarDefaultConfig;

    @Input() config: AngularEditorToolbarConfig;
    ...
    ngOnChanges() {
        ...
        if (this.finalConfig.headings) {
            this.headings = this.finalConfig.headings;
        }
    }
